...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner contenu_caroussel">
    ...
    <section class="usefullness section">
        <div class="container" id="a-quoi">
            <div class="row but">
                <div class="col">
                    <hr>
                </div>
                <div class="col-6">
                    <h1 id="fonction">A quoi sert-&nbsp;il ?</h1>
                </div>
                <div class="col">
                    <hr>
                </div>
    ...
    <section class="fonction section">
        ...
        <div class="container">
            ...
            <div id="contact" class="button-fonction">
                <p>
